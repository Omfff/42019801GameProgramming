...
namespace DuloGames.UI
{
	...
	public class UITab : Toggle {
		...
		private void TriggerAnimation(GameObject target, string triggername)
		{
			...
			if (animator == null || !animator.enabled || !animator.isActiveAndEnabled || !animator.hasBoundPlayables || animator.runtimeAnimatorController == null || string.IsNullOrEmpty(triggername))
				return;
